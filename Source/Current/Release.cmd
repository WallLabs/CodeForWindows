...
tf undo "%~dp0..\..\Build\v1" /recursive /noprompt
if %errorlevel% gtr 1 goto error
tfpt scorch "%~dp0..\..\Build\v1" /recursive /diff /noprompt
if %errorlevel% gtr 1 goto error
...
tf delete "%~dp0..\..\Build\v1" /recursive
if %errorlevel% gtr 1 goto error
rmdir "%~dp0..\..\Build\v1" /s /q
if %errorlevel% neq 0 goto error
tf checkin "%~dp0..\..\Build\v1" /recursive /noprompt
if %errorlevel% gtr 1 goto error
:TargetClean
