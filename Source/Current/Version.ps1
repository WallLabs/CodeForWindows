...
Set-VersionInPowerShellManifest -File "$PSScriptRoot\PowerShell\CodeForWindows.PowerShell.VisualStudio\CodeForWindows.PowerShell.VisualStudio.psd1" -Version $newVersion;
